...
import { Calendar, CheckCircle, XCircle, Clock, Loader2, MapPin, BookOpen, Sparkles } from 'lucide-react';
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        ...
        <p className="text-gray-600">View invitations and manage your attendance</p>
      </div>
