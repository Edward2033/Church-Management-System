-- ============================================================================
-- STEP-BY-STEP MIGRATION: Notification and Attendance System
...
-- STEP 2: Create notification delivery tracking table
-- ============================================================================
...
-- STEP 6: Drop existing views if they exist (to recreate them)
-- ============================================================================
DROP VIEW IF EXISTS attendance_user_stats CASCADE;
DROP VIEW IF EXISTS attendance_session_stats CASCADE;

-- STEP 7: Create views (NOW after all tables exist)
-- ============================================================================
...
-- STEP 8: Create trigger function for notification read count
-- ============================================================================
...
-- DONE!
-- ============================================================================
SELECT 'Migration completed successfully! All tables, views, and triggers created.' as status;
